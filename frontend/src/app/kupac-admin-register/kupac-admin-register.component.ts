...
@Component({
  selector: 'app-kupac-admin-register',
  templateUrl: './kupac-admin-register.component.html',
  styleUrls: ['./kupac-admin-register.component.css']
})
export class KupacAdminRegisterComponent implements OnInit {
