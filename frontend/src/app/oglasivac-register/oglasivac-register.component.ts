...
@Component({
  selector: 'app-oglasivac-register',
  templateUrl: './oglasivac-register.component.html',
  styleUrls: ['./oglasivac-register.component.css']
})
export class OglasivacRegisterComponent implements OnInit {

  constructor(private userService: UserService, private reqService:RequestService,  private router: Router,private http: HttpClient,private agencyService:AgencyService) 
